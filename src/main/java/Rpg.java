        ...
        do {
            ...
            switch (opcao) {
                ...
                System.out.println(" \n\t|              Nesse jogo você terá a missão de ir ao mercado                    |"
                                  ...
                                  + "|         no caminho de sua casa até o mercado e a volta, irão ter alguns        |\n\t"
                                  + "|          envolvendo a matéria Matemática para Tecnologia da informação         |\n\t"
                    ...
                    System.out.println("\n\t " + nome + " sua mãe pede para que você vá no mercado"
                            ...
                            + "\n\t respondendo corretamente você ganhará um bonus de 10 pontos de imunidade."
                            + "\n\n\t -----------Pergunta----------"
                    ...
                    if (respostaChar == 's' || respostaChar == 'S') {
                        ...
                        System.out.println("\t Com isso você perdeu 40 de imunidade");
                    ...
                    System.out.println("\n\t Você anda mais uma quadra e chega em sua casa, o próximo"
                            ...
                            + "\n\t para se proteger completamente do vírus, o recomendado é que você,"
